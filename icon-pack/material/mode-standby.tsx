...
Icon.displayName = 'ModeStandby'

/**
 * Material Icon: Mode Standby
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:mode_standby Material Icon Docs}
 */
export const ModeStandby = memo(Icon)
