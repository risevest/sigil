...
Icon.displayName = 'LocalOffer'

/**
 * Material Icon: Local Offer
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:local_offer Material Icon Docs}
 */
export const LocalOffer = memo(Icon)
