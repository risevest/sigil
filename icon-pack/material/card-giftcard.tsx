...
Icon.displayName = 'CardGiftcard'

/**
 * Material Icon: Card Giftcard
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:card_giftcard Material Icon Docs}
 */
export const CardGiftcard = memo(Icon)
