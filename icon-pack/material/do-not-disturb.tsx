...
Icon.displayName = 'DoNotDisturb'

/**
 * Material Icon: Do Not Disturb
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:do_not_disturb Material Icon Docs}
 */
export const DoNotDisturb = memo(Icon)
