...
Icon.displayName = 'LocalPizza'

/**
 * Material Icon: Local Pizza
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:local_pizza Material Icon Docs}
 */
export const LocalPizza = memo(Icon)
