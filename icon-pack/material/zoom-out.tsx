...
/**
 * Material Icon: Zoom Out
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:zoom_out Material Icon Docs}
 */
export const ZoomOut = memo(Icon)
