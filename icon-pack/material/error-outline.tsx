...
Icon.displayName = 'ErrorOutline'

/**
 * Material Icon: Error Outline
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:error_outline Material Icon Docs}
 */
export const ErrorOutline = memo(Icon)
