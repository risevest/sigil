...
Icon.displayName = 'NotificationsNone'

/**
 * Material Icon: Notifications None
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:notifications_none Material Icon Docs}
 */
export const NotificationsNone = memo(Icon)
