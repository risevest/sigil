...
Icon.displayName = 'BlurCircular'

/**
 * Material Icon: Blur Circular
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:blur_circular Material Icon Docs}
 */
export const BlurCircular = memo(Icon)
