...
Icon.displayName = 'DeveloperBoard'

/**
 * Material Icon: Developer Board
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:developer_board Material Icon Docs}
 */
export const DeveloperBoard = memo(Icon)
