...
Icon.displayName = 'GTranslate'

/**
 * Material Icon: G Translate
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:g_translate Material Icon Docs}
 */
export const GTranslate = memo(Icon)
