...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill={color} height={size} width={size} {...otherProps}>
      ...
      <Path d="M16.5 10.5V9C16.5 8.45 16.05 8 15.5 8H13.5V7H16.5V5.5H12V9H15V10H12V11.5H15.5C16.05 11.5 16.5 11.05 16.5 10.5Z" />
    </Svg>
  )
}

Icon.displayName = 'Mi15mp'

/**
 * Material Icon: 1 5mp
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:1_5mp Material Icon Docs}
 */
export const Mi15mp = memo(Icon)
