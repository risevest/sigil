...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill={color} height={size} width={size} {...otherProps}>
      ...
      <Path d="M9.5 11.5H11V5.5H8V7H9.5V11.5Z" />
      <Path d="M14.5 11.5H16V5.5H13V7H14.5V11.5Z" />
    </Svg>
  )
}

Icon.displayName = 'Mi11mp'

/**
 * Material Icon: 1 1mp
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:1_1mp Material Icon Docs}
 */
export const Mi11mp = memo(Icon)
