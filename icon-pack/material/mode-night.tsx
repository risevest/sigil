...
Icon.displayName = 'ModeNight'

/**
 * Material Icon: Mode Night
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:mode_night Material Icon Docs}
 */
export const ModeNight = memo(Icon)
