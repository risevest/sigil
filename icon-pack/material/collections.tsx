...
Icon.displayName = 'Collections'

/**
 * Material Icon: Collections
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:collections Material Icon Docs}
 */
export const Collections = memo(Icon)
