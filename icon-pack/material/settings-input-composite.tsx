...
Icon.displayName = 'SettingsInputComposite'

/**
 * Material Icon: Settings Input Composite
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:settings_input_composite Material Icon Docs}
 */
export const SettingsInputComposite = memo(Icon)
