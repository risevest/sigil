...
Icon.displayName = 'LocalShipping'

/**
 * Material Icon: Local Shipping
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:local_shipping Material Icon Docs}
 */
export const LocalShipping = memo(Icon)
