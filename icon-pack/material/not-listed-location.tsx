...
Icon.displayName = 'NotListedLocation'

/**
 * Material Icon: Not Listed Location
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:not_listed_location Material Icon Docs}
 */
export const NotListedLocation = memo(Icon)
