...
Icon.displayName = 'SupportAgent'

/**
 * Material Icon: Support Agent
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:support_agent Material Icon Docs}
 */
export const SupportAgent = memo(Icon)
