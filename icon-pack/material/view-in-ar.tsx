...
Icon.displayName = 'ViewInAr'

/**
 * Material Icon: View In Ar
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:view_in_ar Material Icon Docs}
 */
export const ViewInAr = memo(Icon)
