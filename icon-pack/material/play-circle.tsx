...
/**
 * Material Icon: Play Circle
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:play_circle Material Icon Docs}
 */
export const PlayCircle = memo(Icon)
