...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill={color} height={size} width={size} {...otherProps}>
      ...
      <Path d="M13.25 11.5H15L16.46 6.79C16.65 6.15 16.17 5.5 15.5 5.5H12V7H14.62L13.25 11.5Z" />
    </Svg>
  )
}

Icon.displayName = 'Mi17mp'

/**
 * Material Icon: 1 7mp
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:1_7mp Material Icon Docs}
 */
export const Mi17mp = memo(Icon)
