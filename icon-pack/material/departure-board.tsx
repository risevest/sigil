...
Icon.displayName = 'DepartureBoard'

/**
 * Material Icon: Departure Board
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:departure_board Material Icon Docs}
 */
export const DepartureBoard = memo(Icon)
