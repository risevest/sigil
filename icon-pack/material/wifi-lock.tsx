...
Icon.displayName = 'WifiLock'

/**
 * Material Icon: Wifi Lock
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:wifi_lock Material Icon Docs}
 */
export const WifiLock = memo(Icon)
