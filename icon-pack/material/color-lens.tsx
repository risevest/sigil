...
Icon.displayName = 'ColorLens'

/**
 * Material Icon: Color Lens
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:color_lens Material Icon Docs}
 */
export const ColorLens = memo(Icon)
