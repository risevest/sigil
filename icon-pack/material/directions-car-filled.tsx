...
Icon.displayName = 'DirectionsCarFilled'

/**
 * Material Icon: Directions Car Filled
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:directions_car_filled Material Icon Docs}
 */
export const DirectionsCarFilled = memo(Icon)
