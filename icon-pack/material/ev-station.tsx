...
Icon.displayName = 'EvStation'

/**
 * Material Icon: Ev Station
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:ev_station Material Icon Docs}
 */
export const EvStation = memo(Icon)
