...
Icon.displayName = 'LibraryBooks'

/**
 * Material Icon: Library Books
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:library_books Material Icon Docs}
 */
export const LibraryBooks = memo(Icon)
