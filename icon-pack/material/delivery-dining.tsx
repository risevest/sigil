...
Icon.displayName = 'DeliveryDining'

/**
 * Material Icon: Delivery Dining
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:delivery_dining Material Icon Docs}
 */
export const DeliveryDining = memo(Icon)
