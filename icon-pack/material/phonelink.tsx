...
Icon.displayName = 'Phonelink'

/**
 * Material Icon: Phonelink
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:phonelink Material Icon Docs}
 */
export const Phonelink = memo(Icon)
