...
Icon.displayName = 'PersonRemove'

/**
 * Material Icon: Person Remove
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:person_remove Material Icon Docs}
 */
export const PersonRemove = memo(Icon)
