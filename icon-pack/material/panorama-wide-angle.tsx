...
Icon.displayName = 'PanoramaWideAngle'

/**
 * Material Icon: Panorama Wide Angle
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:panorama_wide_angle Material Icon Docs}
 */
export const PanoramaWideAngle = memo(Icon)
