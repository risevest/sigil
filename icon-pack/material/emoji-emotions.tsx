...
Icon.displayName = 'EmojiEmotions'

/**
 * Material Icon: Emoji Emotions
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:emoji_emotions Material Icon Docs}
 */
export const EmojiEmotions = memo(Icon)
