...
Icon.displayName = 'PhonePaused'

/**
 * Material Icon: Phone Paused
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:phone_paused Material Icon Docs}
 */
export const PhonePaused = memo(Icon)
