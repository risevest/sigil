...
Icon.displayName = 'MotionPhotosPause'

/**
 * Material Icon: Motion Photos Pause
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:motion_photos_pause Material Icon Docs}
 */
export const MotionPhotosPause = memo(Icon)
