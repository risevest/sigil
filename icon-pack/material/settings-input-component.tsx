...
Icon.displayName = 'SettingsInputComponent'

/**
 * Material Icon: Settings Input Component
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:settings_input_component Material Icon Docs}
 */
export const SettingsInputComponent = memo(Icon)
