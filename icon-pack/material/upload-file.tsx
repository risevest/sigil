...
Icon.displayName = 'UploadFile'

/**
 * Material Icon: Upload File
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:upload_file Material Icon Docs}
 */
export const UploadFile = memo(Icon)
