...
Icon.displayName = 'IntegrationInstructions'

/**
 * Material Icon: Integration Instructions
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:integration_instructions Material Icon Docs}
 */
export const IntegrationInstructions = memo(Icon)
