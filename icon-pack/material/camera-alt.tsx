...
Icon.displayName = 'CameraAlt'

/**
 * Material Icon: Camera Alt
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:camera_alt Material Icon Docs}
 */
export const CameraAlt = memo(Icon)
