...
Icon.displayName = 'Assignment'

/**
 * Material Icon: Assignment
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:assignment Material Icon Docs}
 */
export const Assignment = memo(Icon)
