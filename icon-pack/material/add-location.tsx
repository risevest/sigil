...
Icon.displayName = 'AddLocation'

/**
 * Material Icon: Add Location
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:add_location Material Icon Docs}
 */
export const AddLocation = memo(Icon)
