...
Icon.displayName = 'PhotoLibrary'

/**
 * Material Icon: Photo Library
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:photo_library Material Icon Docs}
 */
export const PhotoLibrary = memo(Icon)
