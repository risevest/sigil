...
Icon.displayName = 'MoneyOff'

/**
 * Material Icon: Money Off
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:money_off Material Icon Docs}
 */
export const MoneyOff = memo(Icon)
