...
Icon.displayName = 'Surfing'

/**
 * Material Icon: Surfing
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:surfing Material Icon Docs}
 */
export const Surfing = memo(Icon)
