...
Icon.displayName = 'WatchLater'

/**
 * Material Icon: Watch Later
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:watch_later Material Icon Docs}
 */
export const WatchLater = memo(Icon)
