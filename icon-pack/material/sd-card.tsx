...
Icon.displayName = 'SdCard'

/**
 * Material Icon: Sd Card
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:sd_card Material Icon Docs}
 */
export const SdCard = memo(Icon)
