...
Icon.displayName = 'PeopleAlt'

/**
 * Material Icon: People Alt
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:people_alt Material Icon Docs}
 */
export const PeopleAlt = memo(Icon)
