...
Icon.displayName = 'DoNotDisturbOn'

/**
 * Material Icon: Do Not Disturb On
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:do_not_disturb_on Material Icon Docs}
 */
export const DoNotDisturbOn = memo(Icon)
