...
/**
 * Material Icon: Closed Caption
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:closed_caption Material Icon Docs}
 */
export const ClosedCaption = memo(Icon)
