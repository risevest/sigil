...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill={color} height={size} width={size} {...otherProps}>
      ...
      <Path d="M17.5 10H14.5V9H16.5C17.05 9 17.5 8.55 17.5 8V6.5C17.5 5.95 17.05 5.5 16.5 5.5H13V7H16V8H14C13.45 8 13 8.45 13 9V11.5H17.5V10Z" />
    </Svg>
  )
}

Icon.displayName = 'Mi22mp'

/**
 * Material Icon: 2 2mp
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:2_2mp Material Icon Docs}
 */
export const Mi22mp = memo(Icon)
