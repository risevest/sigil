...
Icon.displayName = 'SentimentNeutral'

/**
 * Material Icon: Sentiment Neutral
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:sentiment_neutral Material Icon Docs}
 */
export const SentimentNeutral = memo(Icon)
