...
Icon.displayName = 'Looks6'

/**
 * Material Icon: Looks 6
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:looks_6 Material Icon Docs}
 */
export const Looks6 = memo(Icon)
