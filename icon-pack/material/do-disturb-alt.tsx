...
Icon.displayName = 'DoDisturbAlt'

/**
 * Material Icon: Do Disturb Alt
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:do_disturb_alt Material Icon Docs}
 */
export const DoDisturbAlt = memo(Icon)
