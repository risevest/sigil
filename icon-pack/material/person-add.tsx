...
Icon.displayName = 'PersonAdd'

/**
 * Material Icon: Person Add
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:person_add Material Icon Docs}
 */
export const PersonAdd = memo(Icon)
