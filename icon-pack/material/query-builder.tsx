...
Icon.displayName = 'QueryBuilder'

/**
 * Material Icon: Query Builder
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:query_builder Material Icon Docs}
 */
export const QueryBuilder = memo(Icon)
