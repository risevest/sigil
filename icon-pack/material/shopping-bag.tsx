...
/**
 * Material Icon: Shopping Bag
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:shopping_bag Material Icon Docs}
 */
export const ShoppingBag = memo(Icon)
