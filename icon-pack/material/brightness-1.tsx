...
Icon.displayName = 'Brightness1'

/**
 * Material Icon: Brightness 1
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:brightness_1 Material Icon Docs}
 */
export const Brightness1 = memo(Icon)
