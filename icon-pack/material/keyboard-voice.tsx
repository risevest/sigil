...
Icon.displayName = 'KeyboardVoice'

/**
 * Material Icon: Keyboard Voice
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:keyboard_voice Material Icon Docs}
 */
export const KeyboardVoice = memo(Icon)
