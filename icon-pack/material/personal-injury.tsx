...
Icon.displayName = 'PersonalInjury'

/**
 * Material Icon: Personal Injury
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:personal_injury Material Icon Docs}
 */
export const PersonalInjury = memo(Icon)
