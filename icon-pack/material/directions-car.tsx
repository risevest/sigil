...
Icon.displayName = 'DirectionsCar'

/**
 * Material Icon: Directions Car
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:directions_car Material Icon Docs}
 */
export const DirectionsCar = memo(Icon)
