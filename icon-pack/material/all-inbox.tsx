...
Icon.displayName = 'AllInbox'

/**
 * Material Icon: All Inbox
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:all_inbox Material Icon Docs}
 */
export const AllInbox = memo(Icon)
