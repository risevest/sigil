...
Icon.displayName = 'MoreHoriz'

/**
 * Material Icon: More Horiz
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:more_horiz Material Icon Docs}
 */
export const MoreHoriz = memo(Icon)
