...
Icon.displayName = 'SentimentSatisfied'

/**
 * Material Icon: Sentiment Satisfied
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:sentiment_satisfied Material Icon Docs}
 */
export const SentimentSatisfied = memo(Icon)
