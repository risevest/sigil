...
Icon.displayName = 'DoDisturbOn'

/**
 * Material Icon: Do Disturb On
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:do_disturb_on Material Icon Docs}
 */
export const DoDisturbOn = memo(Icon)
