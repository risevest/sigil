...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill={color} height={size} width={size} {...otherProps}>
      ...
      <Path d="M12.5 11.5H14V10H15V8.5H14V5.5H12.5V8.5H11V5.5H9.5V10H12.5V11.5Z" />
    </Svg>
  )
}

Icon.displayName = 'Mi4mp'

/**
 * Material Icon: 4mp
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:4mp Material Icon Docs}
 */
export const Mi4mp = memo(Icon)
