...
Icon.displayName = 'AccessibilityNew'

/**
 * Material Icon: Accessibility New
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:accessibility_new Material Icon Docs}
 */
export const AccessibilityNew = memo(Icon)
