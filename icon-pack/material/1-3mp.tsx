...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill={color} height={size} width={size} {...otherProps}>
      ...
      <Path d="M16.5 10.5V6.5C16.5 5.95 16.05 5.5 15.5 5.5H12V7H15V8H13V9H15V10H12V11.5H15.5C16.05 11.5 16.5 11.05 16.5 10.5Z" />
...
Icon.displayName = 'Mi13mp'

/**
 * Material Icon: 1 3mp
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:1_3mp Material Icon Docs}
 */
export const Mi13mp = memo(Icon)
