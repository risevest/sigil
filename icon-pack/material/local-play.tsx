...
Icon.displayName = 'LocalPlay'

/**
 * Material Icon: Local Play
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:local_play Material Icon Docs}
 */
export const LocalPlay = memo(Icon)
