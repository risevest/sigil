...
Icon.displayName = 'PointOfSale'

/**
 * Material Icon: Point Of Sale
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:point_of_sale Material Icon Docs}
 */
export const PointOfSale = memo(Icon)
