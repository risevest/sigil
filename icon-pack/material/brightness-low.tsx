...
Icon.displayName = 'BrightnessLow'

/**
 * Material Icon: Brightness Low
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:brightness_low Material Icon Docs}
 */
export const BrightnessLow = memo(Icon)
