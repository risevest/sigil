...
Icon.displayName = 'DriveEta'

/**
 * Material Icon: Drive Eta
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:drive_eta Material Icon Docs}
 */
export const DriveEta = memo(Icon)
