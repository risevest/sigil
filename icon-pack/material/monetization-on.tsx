...
Icon.displayName = 'MonetizationOn'

/**
 * Material Icon: Monetization On
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:monetization_on Material Icon Docs}
 */
export const MonetizationOn = memo(Icon)
