...
Icon.displayName = 'VpnLock'

/**
 * Material Icon: Vpn Lock
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:vpn_lock Material Icon Docs}
 */
export const VpnLock = memo(Icon)
