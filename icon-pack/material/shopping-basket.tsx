...
/**
 * Material Icon: Shopping Basket
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:shopping_basket Material Icon Docs}
 */
export const ShoppingBasket = memo(Icon)
