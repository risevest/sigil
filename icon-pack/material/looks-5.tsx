...
Icon.displayName = 'Looks5'

/**
 * Material Icon: Looks 5
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:looks_5 Material Icon Docs}
 */
export const Looks5 = memo(Icon)
