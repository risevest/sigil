...
Icon.displayName = 'ReduceCapacity'

/**
 * Material Icon: Reduce Capacity
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:reduce_capacity Material Icon Docs}
 */
export const ReduceCapacity = memo(Icon)
