...
Icon.displayName = 'ThumbDownAlt'

/**
 * Material Icon: Thumb Down Alt
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:thumb_down_alt Material Icon Docs}
 */
export const ThumbDownAlt = memo(Icon)
