...
Icon.displayName = 'DoDisturb'

/**
 * Material Icon: Do Disturb
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:do_disturb Material Icon Docs}
 */
export const DoDisturb = memo(Icon)
