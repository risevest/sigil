...
Icon.displayName = 'PanoramaPhotosphere'

/**
 * Material Icon: Panorama Photosphere
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:panorama_photosphere Material Icon Docs}
 */
export const PanoramaPhotosphere = memo(Icon)
