...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill={color} height={size} width={size} {...otherProps}>
      ...
      <Path d="M16.5 10H13.5V9H15.5C16.05 9 16.5 8.55 16.5 8V6.5C16.5 5.95 16.05 5.5 15.5 5.5H12V7H15V8H13C12.45 8 12 8.45 12 9V11.5H16.5V10Z" />
    </Svg>
  )
}

Icon.displayName = 'Mi12mp'

/**
 * Material Icon: 1 2mp
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:1_2mp Material Icon Docs}
 */
export const Mi12mp = memo(Icon)
