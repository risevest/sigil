...
Icon.displayName = 'PanoramaHorizontal'

/**
 * Material Icon: Panorama Horizontal
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:panorama_horizontal Material Icon Docs}
 */
export const PanoramaHorizontal = memo(Icon)
