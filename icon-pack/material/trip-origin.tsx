...
Icon.displayName = 'TripOrigin'

/**
 * Material Icon: Trip Origin
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:trip_origin Material Icon Docs}
 */
export const TripOrigin = memo(Icon)
