...
Icon.displayName = 'ChildCare'

/**
 * Material Icon: Child Care
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:child_care Material Icon Docs}
 */
export const ChildCare = memo(Icon)
