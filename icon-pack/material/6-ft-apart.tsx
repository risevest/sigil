...
Icon.displayName = 'Mi6FtApart'

/**
 * Material Icon: 6 Ft Apart
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:6_ft_apart Material Icon Docs}
 */
export const Mi6FtApart = memo(Icon)
