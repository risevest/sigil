...
Icon.displayName = 'AccessTime'

/**
 * Material Icon: Access Time
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:access_time Material Icon Docs}
 */
export const AccessTime = memo(Icon)
