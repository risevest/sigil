...
Icon.displayName = 'Person4'

/**
 * Material Icon: Person 4
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:person_4 Material Icon Docs}
 */
export const Person4 = memo(Icon)
