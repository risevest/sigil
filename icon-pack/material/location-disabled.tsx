...
Icon.displayName = 'LocationDisabled'

/**
 * Material Icon: Location Disabled
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:location_disabled Material Icon Docs}
 */
export const LocationDisabled = memo(Icon)
