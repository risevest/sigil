...
Icon.displayName = 'AlternateEmail'

/**
 * Material Icon: Alternate Email
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:alternate_email Material Icon Docs}
 */
export const AlternateEmail = memo(Icon)
