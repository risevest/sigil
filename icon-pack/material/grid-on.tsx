...
Icon.displayName = 'GridOn'

/**
 * Material Icon: Grid On
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:grid_on Material Icon Docs}
 */
export const GridOn = memo(Icon)
