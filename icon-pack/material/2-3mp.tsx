...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill={color} height={size} width={size} {...otherProps}>
      ...
      <Path d="M17.5 10.5V6.5C17.5 5.95 17.05 5.5 16.5 5.5H13V7H16V8H14V9H16V10H13V11.5H16.5C17.05 11.5 17.5 11.05 17.5 10.5Z" />
    </Svg>
  )
}

Icon.displayName = 'Mi23mp'

/**
 * Material Icon: 2 3mp
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:2_3mp Material Icon Docs}
 */
export const Mi23mp = memo(Icon)
