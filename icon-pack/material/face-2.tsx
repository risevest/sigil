...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill={color} height={size} width={size} {...otherProps}>
      <G clipPath="url(#clip0_2403_4420)">
...
Icon.displayName = 'Face2'

/**
 * Material Icon: Face 2
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:face_2 Material Icon Docs}
 */
export const Face2 = memo(Icon)
