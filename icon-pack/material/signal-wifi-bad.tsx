...
Icon.displayName = 'SignalWifiBad'

/**
 * Material Icon: Signal Wifi Bad
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:signal_wifi_bad Material Icon Docs}
 */
export const SignalWifiBad = memo(Icon)
