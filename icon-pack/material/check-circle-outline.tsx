...
Icon.displayName = 'CheckCircleOutline'

/**
 * Material Icon: Check Circle Outline
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:check_circle_outline Material Icon Docs}
 */
export const CheckCircleOutline = memo(Icon)
