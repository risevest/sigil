...
Icon.displayName = 'ContentPaste'

/**
 * Material Icon: Content Paste
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:content_paste Material Icon Docs}
 */
export const ContentPaste = memo(Icon)
