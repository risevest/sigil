...
Icon.displayName = 'DirectionsTransit'

/**
 * Material Icon: Directions Transit
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:directions_transit Material Icon Docs}
 */
export const DirectionsTransit = memo(Icon)
