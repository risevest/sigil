...
const Icon = (props: IconProps) => {
  ...
  return (
    <Svg viewBox="0 0 24 24" fill="none" height={size} width={size} {...otherProps}>
      <G clipPath="url(#clip0_2403_5871)">
        <Path
...
Icon.displayName = 'Hub'

/**
 * Material Icon: Hub
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:hub Material Icon Docs}
 */
export const Hub = memo(Icon)
