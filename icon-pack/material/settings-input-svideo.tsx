...
Icon.displayName = 'SettingsInputSvideo'

/**
 * Material Icon: Settings Input Svideo
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:settings_input_svideo Material Icon Docs}
 */
export const SettingsInputSvideo = memo(Icon)
