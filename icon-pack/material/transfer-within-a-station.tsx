...
Icon.displayName = 'TransferWithinAStation'

/**
 * Material Icon: Transfer Within A Station
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:transfer_within_a_station Material Icon Docs}
 */
export const TransferWithinAStation = memo(Icon)
