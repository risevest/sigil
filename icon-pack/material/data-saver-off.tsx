...
Icon.displayName = 'DataSaverOff'

/**
 * Material Icon: Data Saver Off
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:data_saver_off Material Icon Docs}
 */
export const DataSaverOff = memo(Icon)
