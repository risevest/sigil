...
Icon.displayName = 'PermPhoneMsg'

/**
 * Material Icon: Perm Phone Msg
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:perm_phone_msg Material Icon Docs}
 */
export const PermPhoneMsg = memo(Icon)
