...
Icon.displayName = 'StarOutline'

/**
 * Material Icon: Star Outline
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:star_outline Material Icon Docs}
 */
export const StarOutline = memo(Icon)
