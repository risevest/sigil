...
Icon.displayName = 'LocalHotel'

/**
 * Material Icon: Local Hotel
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:local_hotel Material Icon Docs}
 */
export const LocalHotel = memo(Icon)
