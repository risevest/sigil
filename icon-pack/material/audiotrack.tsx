...
Icon.displayName = 'Audiotrack'

/**
 * Material Icon: Audiotrack
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:audiotrack Material Icon Docs}
 */
export const Audiotrack = memo(Icon)
