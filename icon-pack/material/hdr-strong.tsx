...
Icon.displayName = 'HdrStrong'

/**
 * Material Icon: Hdr Strong
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:hdr_strong Material Icon Docs}
 */
export const HdrStrong = memo(Icon)
