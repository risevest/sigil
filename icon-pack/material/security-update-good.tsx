...
Icon.displayName = 'SecurityUpdateGood'

/**
 * Material Icon: Security Update Good
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:security_update_good Material Icon Docs}
 */
export const SecurityUpdateGood = memo(Icon)
