...
Icon.displayName = 'ExitToApp'

/**
 * Material Icon: Exit To App
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:exit_to_app Material Icon Docs}
 */
export const ExitToApp = memo(Icon)
