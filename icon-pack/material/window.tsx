...
Icon.displayName = 'Window'

/**
 * Material Icon: Window
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:window Material Icon Docs}
 */
export const Window = memo(Icon)
