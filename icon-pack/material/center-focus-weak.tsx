...
Icon.displayName = 'CenterFocusWeak'

/**
 * Material Icon: Center Focus Weak
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:center_focus_weak Material Icon Docs}
 */
export const CenterFocusWeak = memo(Icon)
