...
Icon.displayName = 'GpsNotFixed'

/**
 * Material Icon: Gps Not Fixed
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:gps_not_fixed Material Icon Docs}
 */
export const GpsNotFixed = memo(Icon)
