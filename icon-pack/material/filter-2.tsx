...
Icon.displayName = 'Filter2'

/**
 * Material Icon: Filter 2
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:filter_2 Material Icon Docs}
 */
export const Filter2 = memo(Icon)
