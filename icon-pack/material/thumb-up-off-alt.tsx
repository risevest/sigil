...
Icon.displayName = 'ThumbUpOffAlt'

/**
 * Material Icon: Thumb Up Off Alt
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:thumb_up_off_alt Material Icon Docs}
 */
export const ThumbUpOffAlt = memo(Icon)
