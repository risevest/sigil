...
Icon.displayName = 'CalendarMonth'

/**
 * Material Icon: Calendar Month
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:calendar_month Material Icon Docs}
 */
export const CalendarMonth = memo(Icon)
