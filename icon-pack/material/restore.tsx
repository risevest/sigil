...
Icon.displayName = 'Restore'

/**
 * Material Icon: Restore
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:restore Material Icon Docs}
 */
export const Restore = memo(Icon)
