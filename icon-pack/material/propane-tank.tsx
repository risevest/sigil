...
Icon.displayName = 'PropaneTank'

/**
 * Material Icon: Propane Tank
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:propane_tank Material Icon Docs}
 */
export const PropaneTank = memo(Icon)
