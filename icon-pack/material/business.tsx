...
Icon.displayName = 'Business'

/**
 * Material Icon: Business
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:business Material Icon Docs}
 */
export const Business = memo(Icon)
