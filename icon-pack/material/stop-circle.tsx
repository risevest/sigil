...
/**
 * Material Icon: Stop Circle
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:stop_circle Material Icon Docs}
 */
export const StopCircle = memo(Icon)
