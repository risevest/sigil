...
/**
 * Material Icon: Folder Open
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:folder_open Material Icon Docs}
 */
export const FolderOpen = memo(Icon)
