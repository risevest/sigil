...
Icon.displayName = 'DirectionsTransitFilled'

/**
 * Material Icon: Directions Transit Filled
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:directions_transit_filled Material Icon Docs}
 */
export const DirectionsTransitFilled = memo(Icon)
