...
Icon.displayName = 'SportsSoccer'

/**
 * Material Icon: Sports Soccer
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:sports_soccer Material Icon Docs}
 */
export const SportsSoccer = memo(Icon)
