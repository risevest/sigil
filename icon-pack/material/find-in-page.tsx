...
Icon.displayName = 'FindInPage'

/**
 * Material Icon: Find In Page
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:find_in_page Material Icon Docs}
 */
export const FindInPage = memo(Icon)
