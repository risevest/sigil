...
/**
 * Material Icon: Pause Circle
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:pause_circle Material Icon Docs}
 */
export const PauseCircle = memo(Icon)
