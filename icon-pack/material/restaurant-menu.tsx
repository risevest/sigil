...
Icon.displayName = 'RestaurantMenu'

/**
 * Material Icon: Restaurant Menu
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:restaurant_menu Material Icon Docs}
 */
export const RestaurantMenu = memo(Icon)
