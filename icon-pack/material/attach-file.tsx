...
Icon.displayName = 'AttachFile'

/**
 * Material Icon: Attach File
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:attach_file Material Icon Docs}
 */
export const AttachFile = memo(Icon)
