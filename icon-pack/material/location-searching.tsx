...
Icon.displayName = 'LocationSearching'

/**
 * Material Icon: Location Searching
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:location_searching Material Icon Docs}
 */
export const LocationSearching = memo(Icon)
