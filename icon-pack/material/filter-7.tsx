...
Icon.displayName = 'Filter7'

/**
 * Material Icon: Filter 7
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:filter_7 Material Icon Docs}
 */
export const Filter7 = memo(Icon)
