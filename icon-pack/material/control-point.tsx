...
Icon.displayName = 'ControlPoint'

/**
 * Material Icon: Control Point
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:control_point Material Icon Docs}
 */
export const ControlPoint = memo(Icon)
