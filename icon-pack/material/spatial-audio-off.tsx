...
Icon.displayName = 'SpatialAudioOff'

/**
 * Material Icon: Spatial Audio Off
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:spatial_audio_off Material Icon Docs}
 */
export const SpatialAudioOff = memo(Icon)
