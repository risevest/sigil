...
Icon.displayName = 'TwoWheeler'

/**
 * Material Icon: Two Wheeler
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:two_wheeler Material Icon Docs}
 */
export const TwoWheeler = memo(Icon)
