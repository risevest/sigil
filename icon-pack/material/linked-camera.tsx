...
Icon.displayName = 'LinkedCamera'

/**
 * Material Icon: Linked Camera
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:linked_camera Material Icon Docs}
 */
export const LinkedCamera = memo(Icon)
