...
Icon.displayName = 'InsertLink'

/**
 * Material Icon: Insert Link
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:insert_link Material Icon Docs}
 */
export const InsertLink = memo(Icon)
