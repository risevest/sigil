...
Icon.displayName = 'BlurLinear'

/**
 * Material Icon: Blur Linear
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:blur_linear Material Icon Docs}
 */
export const BlurLinear = memo(Icon)
