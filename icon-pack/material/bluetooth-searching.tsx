...
/**
 * Material Icon: Bluetooth Searching
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:bluetooth_searching Material Icon Docs}
 */
export const BluetoothSearching = memo(Icon)
