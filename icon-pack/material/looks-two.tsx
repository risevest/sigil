...
Icon.displayName = 'LooksTwo'

/**
 * Material Icon: Looks Two
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:looks_two Material Icon Docs}
 */
export const LooksTwo = memo(Icon)
