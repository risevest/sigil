...
Icon.displayName = 'WavingHand'

/**
 * Material Icon: Waving Hand
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:waving_hand Material Icon Docs}
 */
export const WavingHand = memo(Icon)
