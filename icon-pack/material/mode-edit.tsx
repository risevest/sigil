...
Icon.displayName = 'ModeEdit'

/**
 * Material Icon: Mode Edit
 * @see {@link https://fonts.google.com/icons?selected=Material+Icons:mode_edit Material Icon Docs}
 */
export const ModeEdit = memo(Icon)
