  ...
  return (
    <Svg height={size} width={size} {...otherProps}>
      <G fill={color} fillRule="evenodd">
        ...
        <Path
          fill={color}
          d="M8.465 10.293a1 1 0 0 1 1.414 0L12 12.414l2.121-2.121a1 1 0 0 1 1.415 1.414l-2.829 2.829a1 1 0 0 1-1.414 0l-2.828-2.829a1 1 0 0 1 0-1.414Z"
        />
      </G>
    </Svg>
  )
...
Icon.displayName = 'DownSmallLine'

/**
 * MingCute Icon: Down Small Line
 * @see {@link https://www.mingcute.com MingCute Icon Docs}
 */
export const DownSmallLine = memo(Icon)
