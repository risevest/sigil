  ...
  return (
    <Svg height={size} width={size} {...otherProps}>
      <G fill={color} fillRule="evenodd">
        ...
        <Path
          fill={color}
          d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm2.997-6.997a1 1 0 0 0-1-1H11.41l4.296-4.296a1 1 0 0 0-1.414-1.414l-4.296 4.296v-2.586a1 1 0 1 0-2 0v5a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1Z"
        />
      </G>
    </Svg>
  )
...
Icon.displayName = 'ArrowLeftDownCircleFill'

/**
 * MingCute Icon: Arrow_left_down_circle_fill
 * @see {@link https://www.mingcute.com MingCute Icon Docs}
 */
export const ArrowLeftDownCircleFill = memo(Icon)
