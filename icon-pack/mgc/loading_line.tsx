  ...
  return (
    <Svg height={size} width={size} {...otherProps}>
      <Defs>
        ...
        <LinearGradient id="b" x1="50%" x2="50%" y1="8.877%" y2="90.415%">
      ...
      <G fill={color}>
        ...
        <Path
          fill={color}
          d="M14.322 1.985a1 1 0 0 1 1.392-.248A9.988 9.988 0 0 1 20 9.945c0 5.523-4.477 10-10 10v-2a8 8 0 0 0 4.57-14.567 1 1 0 0 1-.248-1.393"
          transform="translate(2 2.055)"
        />
      </G>
    </Svg>
...
/**
 * MingCute Icon: Loading_line
 * @see {@link https://www.mingcute.com MingCute Icon Docs}
 */
export const LoadingLine = memo(Icon)
