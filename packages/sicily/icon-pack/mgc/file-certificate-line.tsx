...
const FileCertificateLine = /* @__PURE__ */ memo(function FileCertificateLine(
  _props: IconProps
) {
  const props = _props
  return (
...
/**
 * MingCute Icon: File Certificate Line
 * @see {@link https://www.mingcute.com MingCute Icon Docs}
 */
export { FileCertificateLine }
