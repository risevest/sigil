...
const ArrowRightUpCircleLine = /* @__PURE__ */ memo(function ArrowRightUpCircleLine(
  _props: IconProps
) {
  const props = _props
  return (
    <svg viewBox="0 0 24 24" width="1em" height="1em" {...props}>
      <g fill="none">
        ...
        <path
          fill="currentColor"
          d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2m0 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16m3.003 3.997a1 1 0 0 1 .994.883l.006.117v5a1 1 0 0 1-1.993.117l-.007-.117v-2.586l-4.296 4.296a1 1 0 0 1-1.497-1.32l.083-.094 4.296-4.296h-2.586a1 1 0 0 1-.116-1.993l.116-.007z"
        />
      </g>
    </svg>
  )
