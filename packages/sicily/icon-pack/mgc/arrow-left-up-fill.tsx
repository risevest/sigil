...
const ArrowLeftUpFill = /* @__PURE__ */ memo(function ArrowLeftUpFill(_props: IconProps) {
  const props = _props
  return (
    <svg viewBox="0 0 24 24" width="1em" height="1em" {...props}>
      <g fill="none">
        ...
        <path
          fill="currentColor"
          d="M4.5 6A1.5 1.5 0 0 1 6 4.5h8a1.5 1.5 0 0 1 0 3H9.621l9.097 9.097a1.5 1.5 0 0 1-2.122 2.12L7.5 9.623V14a1.5 1.5 0 0 1-3 0z"
        />
      </g>
    </svg>
  )
...
/**
 * MingCute Icon: Arrow Left Up Fill
