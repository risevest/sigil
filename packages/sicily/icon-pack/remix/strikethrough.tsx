...
const Strikethrough = /* @__PURE__ */ memo(function Strikethrough(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Strikethrough
 * @see {@link https://remixicon.com/icon/strikethrough Remix Icon Docs}
 */
