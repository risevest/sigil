...
const SubwayWifiFill = /* @__PURE__ */ memo(function SubwayWifiFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Subway Wifi Fill
 * @see {@link https://remixicon.com/icon/subway-wifi-fill Remix Icon Docs}
 */
