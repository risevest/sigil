...
const MicOffLine = /* @__PURE__ */ memo(function MicOffLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Mic Off Line
 * @see {@link https://remixicon.com/icon/mic-off-line Remix Icon Docs}
 */
export { MicOffLine }
