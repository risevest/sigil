...
const DropperFill = /* @__PURE__ */ memo(function DropperFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Dropper Fill
 * @see {@link https://remixicon.com/icon/dropper-fill Remix Icon Docs}
 */
export { DropperFill }
