...
const QuillPenAiLine = /* @__PURE__ */ memo(function QuillPenAiLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Quill Pen Ai Line
 * @see {@link https://remixicon.com/icon/quill-pen-ai-line Remix Icon Docs}
 */
