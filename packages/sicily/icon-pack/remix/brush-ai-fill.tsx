...
const BrushAiFill = /* @__PURE__ */ memo(function BrushAiFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Brush Ai Fill
 * @see {@link https://remixicon.com/icon/brush-ai-fill Remix Icon Docs}
 */
export { BrushAiFill }
