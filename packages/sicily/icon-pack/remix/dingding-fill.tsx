...
const DingdingFill = /* @__PURE__ */ memo(function DingdingFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Dingding Fill
 * @see {@link https://remixicon.com/icon/dingding-fill Remix Icon Docs}
 */
export { DingdingFill }
