...
const BroadcastFill = /* @__PURE__ */ memo(function BroadcastFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Broadcast Fill
 * @see {@link https://remixicon.com/icon/broadcast-fill Remix Icon Docs}
 */
