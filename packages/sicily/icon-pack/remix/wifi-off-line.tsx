...
const WifiOffLine = /* @__PURE__ */ memo(function WifiOffLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Wifi Off Line
 * @see {@link https://remixicon.com/icon/wifi-off-line Remix Icon Docs}
 */
export { WifiOffLine }
