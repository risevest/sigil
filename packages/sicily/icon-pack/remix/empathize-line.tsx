...
const EmpathizeLine = /* @__PURE__ */ memo(function EmpathizeLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Empathize Line
 * @see {@link https://remixicon.com/icon/empathize-line Remix Icon Docs}
 */
