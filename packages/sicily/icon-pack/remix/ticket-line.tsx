...
const TicketLine = /* @__PURE__ */ memo(function TicketLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Ticket Line
 * @see {@link https://remixicon.com/icon/ticket-line Remix Icon Docs}
 */
export { TicketLine }
