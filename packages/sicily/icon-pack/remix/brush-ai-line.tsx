...
const BrushAiLine = /* @__PURE__ */ memo(function BrushAiLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Brush Ai Line
 * @see {@link https://remixicon.com/icon/brush-ai-line Remix Icon Docs}
 */
export { BrushAiLine }
