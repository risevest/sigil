...
const DropperLine = /* @__PURE__ */ memo(function DropperLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Dropper Line
 * @see {@link https://remixicon.com/icon/dropper-line Remix Icon Docs}
 */
export { DropperLine }
