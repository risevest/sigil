...
const EyeOffLine = /* @__PURE__ */ memo(function EyeOffLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Eye Off Line
 * @see {@link https://remixicon.com/icon/eye-off-line Remix Icon Docs}
 */
export { EyeOffLine }
