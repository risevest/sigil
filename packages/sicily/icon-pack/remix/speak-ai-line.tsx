...
const SpeakAiLine = /* @__PURE__ */ memo(function SpeakAiLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Speak Ai Line
 * @see {@link https://remixicon.com/icon/speak-ai-line Remix Icon Docs}
 */
export { SpeakAiLine }
