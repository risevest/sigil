...
const Mic2AiLine = /* @__PURE__ */ memo(function Mic2AiLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Mic 2 Ai Line
 * @see {@link https://remixicon.com/icon/mic-2-ai-line Remix Icon Docs}
 */
export { Mic2AiLine }
