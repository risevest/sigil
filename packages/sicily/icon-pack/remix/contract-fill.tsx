...
const ContractFill = /* @__PURE__ */ memo(function ContractFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Contract Fill
 * @see {@link https://remixicon.com/icon/contract-fill Remix Icon Docs}
 */
export { ContractFill }
