...
const SpaceShipLine = /* @__PURE__ */ memo(function SpaceShipLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Space Ship Line
 * @see {@link https://remixicon.com/icon/space-ship-line Remix Icon Docs}
 */
