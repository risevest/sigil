...
const EBike2Line = /* @__PURE__ */ memo(function EBike2Line(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: E Bike 2 Line
 * @see {@link https://remixicon.com/icon/e-bike-2-line Remix Icon Docs}
 */
export { EBike2Line }
