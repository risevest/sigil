...
const HeartsLine = /* @__PURE__ */ memo(function HeartsLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Hearts Line
 * @see {@link https://remixicon.com/icon/hearts-line Remix Icon Docs}
 */
export { HeartsLine }
