...
const JavascriptFill = /* @__PURE__ */ memo(function JavascriptFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Javascript Fill
 * @see {@link https://remixicon.com/icon/javascript-fill Remix Icon Docs}
 */
