...
const ChatVoiceAiFill = /* @__PURE__ */ memo(function ChatVoiceAiFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Chat Voice Ai Fill
 * @see {@link https://remixicon.com/icon/chat-voice-ai-fill Remix Icon Docs}
 */
