...
const ChatSmileAiLine = /* @__PURE__ */ memo(function ChatSmileAiLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Chat Smile Ai Line
 * @see {@link https://remixicon.com/icon/chat-smile-ai-line Remix Icon Docs}
 */
