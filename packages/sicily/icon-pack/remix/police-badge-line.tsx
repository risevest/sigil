...
const PoliceBadgeLine = /* @__PURE__ */ memo(function PoliceBadgeLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Police Badge Line
 * @see {@link https://remixicon.com/icon/police-badge-line Remix Icon Docs}
 */
