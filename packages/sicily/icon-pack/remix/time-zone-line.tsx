...
const TimeZoneLine = /* @__PURE__ */ memo(function TimeZoneLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Time Zone Line
 * @see {@link https://remixicon.com/icon/time-zone-line Remix Icon Docs}
 */
export { TimeZoneLine }
