...
const BilibiliLine = /* @__PURE__ */ memo(function BilibiliLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Bilibili Line
 * @see {@link https://remixicon.com/icon/bilibili-line Remix Icon Docs}
 */
export { BilibiliLine }
