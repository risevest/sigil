...
const SvelteLine = /* @__PURE__ */ memo(function SvelteLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Svelte Line
 * @see {@link https://remixicon.com/icon/svelte-line Remix Icon Docs}
 */
export { SvelteLine }
