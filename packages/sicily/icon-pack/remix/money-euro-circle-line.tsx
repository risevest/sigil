...
Icon.displayName = 'MoneyEuroCircleLine'
/**
 * Remix Icon: Money Euro Circle Line
 * @see {@link https://remixicon.com/icon/money-euro-circle-line Remix Icon Docs}
 */
export const MoneyEuroCircleLine = Icon
