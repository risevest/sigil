...
Icon.displayName = 'ImageCircleAiFill'
/**
 * Remix Icon: Image Circle Ai Fill
 * @see {@link https://remixicon.com/icon/image-circle-ai-fill Remix Icon Docs}
 */
export const ImageCircleAiFill = Icon
