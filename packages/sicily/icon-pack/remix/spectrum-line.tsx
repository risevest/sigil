...
const SpectrumLine = /* @__PURE__ */ memo(function SpectrumLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Spectrum Line
 * @see {@link https://remixicon.com/icon/spectrum-line Remix Icon Docs}
 */
export { SpectrumLine }
