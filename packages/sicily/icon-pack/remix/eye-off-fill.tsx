...
const EyeOffFill = /* @__PURE__ */ memo(function EyeOffFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Eye Off Fill
 * @see {@link https://remixicon.com/icon/eye-off-fill Remix Icon Docs}
 */
export { EyeOffFill }
