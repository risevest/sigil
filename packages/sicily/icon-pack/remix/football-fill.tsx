...
const FootballFill = /* @__PURE__ */ memo(function FootballFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Football Fill
 * @see {@link https://remixicon.com/icon/football-fill Remix Icon Docs}
 */
export { FootballFill }
