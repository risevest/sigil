...
const TwitterFill = /* @__PURE__ */ memo(function TwitterFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Twitter Fill
 * @see {@link https://remixicon.com/icon/twitter-fill Remix Icon Docs}
 */
export { TwitterFill }
