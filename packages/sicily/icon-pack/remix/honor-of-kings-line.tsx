...
Icon.displayName = 'HonorOfKingsLine'
/**
 * Remix Icon: Honor Of Kings Line
 * @see {@link https://remixicon.com/icon/honor-of-kings-line Remix Icon Docs}
 */
export const HonorOfKingsLine = Icon
