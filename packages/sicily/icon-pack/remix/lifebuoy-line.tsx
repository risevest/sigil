...
const LifebuoyLine = /* @__PURE__ */ memo(function LifebuoyLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Lifebuoy Line
 * @see {@link https://remixicon.com/icon/lifebuoy-line Remix Icon Docs}
 */
export { LifebuoyLine }
