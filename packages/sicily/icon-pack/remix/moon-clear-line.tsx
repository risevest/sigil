...
const MoonClearLine = /* @__PURE__ */ memo(function MoonClearLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Moon Clear Line
 * @see {@link https://remixicon.com/icon/moon-clear-line Remix Icon Docs}
 */
