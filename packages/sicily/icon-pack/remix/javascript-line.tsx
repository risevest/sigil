...
const JavascriptLine = /* @__PURE__ */ memo(function JavascriptLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Javascript Line
 * @see {@link https://remixicon.com/icon/javascript-line Remix Icon Docs}
 */
