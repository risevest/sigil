...
Icon.displayName = 'DiscountPercentFill'
/**
 * Remix Icon: Discount Percent Fill
 * @see {@link https://remixicon.com/icon/discount-percent-fill Remix Icon Docs}
 */
export const DiscountPercentFill = Icon
