...
const MoonCloudyLine = /* @__PURE__ */ memo(function MoonCloudyLine(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Moon Cloudy Line
 * @see {@link https://remixicon.com/icon/moon-cloudy-line Remix Icon Docs}
 */
