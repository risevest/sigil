...
const Compasses2Line = /* @__PURE__ */ memo(function Compasses2Line(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Compasses 2 Line
 * @see {@link https://remixicon.com/icon/compasses-2-line Remix Icon Docs}
 */
