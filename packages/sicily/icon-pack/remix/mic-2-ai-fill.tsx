...
const Mic2AiFill = /* @__PURE__ */ memo(function Mic2AiFill(_props: IconProps) {
  const props = _props
  return (
...
/**
 * Remix Icon: Mic 2 Ai Fill
 * @see {@link https://remixicon.com/icon/mic-2-ai-fill Remix Icon Docs}
 */
export { Mic2AiFill }
