...
const ArrowLeftUpCircleFill = /* @__PURE__ */ memo(function ArrowLeftUpCircleFill(
  _props: IconProps
) {
  ...
  return (
    <Svg viewBox="0 0 24 24" width={size} height={size} {...props}>
      <G fill="none" fillRule="evenodd">
        ...
        <Path
          fill={color}
          d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10m-3.003-7.003a1 1 0 0 0 1-1V11.41l4.296 4.296a1 1 0 1 0 1.414-1.414l-4.296-4.296h2.586a1 1 0 1 0 0-2h-5a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1Z"
        />
      </G>
    </Svg>
  )
...
/**
 * MingCute Icon: Arrow Left Up Circle Fill
 * @see {@link https://www.mingcute.com MingCute Icon Docs}
 */
export { ArrowLeftUpCircleFill }
