...
const ArrowRightDownCircleFill = /* @__PURE__ */ memo(function ArrowRightDownCircleFill(
  _props: IconProps
) {
  ...
  return (
    <Svg viewBox="0 0 24 24" width={size} height={size} {...props}>
      <G fill="none" fillRule="evenodd">
        ...
        <Path
          fill={color}
          d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10m3.003-12.997a1 1 0 0 0-1 1v2.586L9.707 8.293a1 1 0 0 0-1.414 1.414l4.296 4.296h-2.586a1 1 0 0 0 0 2h5a1 1 0 0 0 1-1v-5a1 1 0 0 0-1-1"
        />
      </G>
    </Svg>
  )
...
/**
 * MingCute Icon: Arrow Right Down Circle Fill
 * @see {@link https://www.mingcute.com MingCute Icon Docs}
 */
export { ArrowRightDownCircleFill }
