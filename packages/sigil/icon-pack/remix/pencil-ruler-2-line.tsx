...
Icon.displayName = 'PencilRuler2Line'
/**
 * Remix Icon: Pencil Ruler 2 Line
 * @see {@link https://remixicon.com/icon/pencil-ruler-2-line Remix Icon Docs}
 */
export const PencilRuler2Line = Icon
