...
const DoubanFill = /* @__PURE__ */ memo(function DoubanFill(_props: IconProps) {
...
/**
 * Remix Icon: Douban Fill
 * @see {@link https://remixicon.com/icon/douban-fill Remix Icon Docs}
 */
export { DoubanFill }
