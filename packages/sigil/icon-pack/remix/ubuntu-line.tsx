...
const UbuntuLine = /* @__PURE__ */ memo(function UbuntuLine(_props: IconProps) {
...
/**
 * Remix Icon: Ubuntu Line
 * @see {@link https://remixicon.com/icon/ubuntu-line Remix Icon Docs}
 */
export { UbuntuLine }
