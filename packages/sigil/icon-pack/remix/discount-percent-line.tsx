...
Icon.displayName = 'DiscountPercentLine'
/**
 * Remix Icon: Discount Percent Line
 * @see {@link https://remixicon.com/icon/discount-percent-line Remix Icon Docs}
 */
export const DiscountPercentLine = Icon
