...
Icon.displayName = 'ImageCircleAiLine'
/**
 * Remix Icon: Image Circle Ai Line
 * @see {@link https://remixicon.com/icon/image-circle-ai-line Remix Icon Docs}
 */
export const ImageCircleAiLine = Icon
