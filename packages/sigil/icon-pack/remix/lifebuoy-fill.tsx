...
const LifebuoyFill = /* @__PURE__ */ memo(function LifebuoyFill(_props: IconProps) {
...
/**
 * Remix Icon: Lifebuoy Fill
 * @see {@link https://remixicon.com/icon/lifebuoy-fill Remix Icon Docs}
 */
export { LifebuoyFill }
