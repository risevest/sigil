...
Icon.displayName = 'ColorFilterAiLine'
/**
 * Remix Icon: Color Filter Ai Line
 * @see {@link https://remixicon.com/icon/color-filter-ai-line Remix Icon Docs}
 */
export const ColorFilterAiLine = Icon
