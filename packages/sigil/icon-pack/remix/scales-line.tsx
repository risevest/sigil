...
const ScalesLine = /* @__PURE__ */ memo(function ScalesLine(_props: IconProps) {
...
/**
 * Remix Icon: Scales Line
 * @see {@link https://remixicon.com/icon/scales-line Remix Icon Docs}
 */
export { ScalesLine }
