...
const InfinityFill = /* @__PURE__ */ memo(function InfinityFill(_props: IconProps) {
...
/**
 * Remix Icon: Infinity Fill
 * @see {@link https://remixicon.com/icon/infinity-fill Remix Icon Docs}
 */
export { InfinityFill }
