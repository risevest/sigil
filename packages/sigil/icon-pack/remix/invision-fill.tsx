...
const InvisionFill = /* @__PURE__ */ memo(function InvisionFill(_props: IconProps) {
...
/**
 * Remix Icon: Invision Fill
 * @see {@link https://remixicon.com/icon/invision-fill Remix Icon Docs}
 */
export { InvisionFill }
