...
Icon.displayName = 'WechatChannelsFill'
/**
 * Remix Icon: Wechat Channels Fill
 * @see {@link https://remixicon.com/icon/wechat-channels-fill Remix Icon Docs}
 */
export const WechatChannelsFill = Icon
