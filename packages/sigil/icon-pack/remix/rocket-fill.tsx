...
const RocketFill = /* @__PURE__ */ memo(function RocketFill(_props: IconProps) {
...
/**
 * Remix Icon: Rocket Fill
 * @see {@link https://remixicon.com/icon/rocket-fill Remix Icon Docs}
 */
export { RocketFill }
