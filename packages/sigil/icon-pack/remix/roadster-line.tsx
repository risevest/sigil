...
const RoadsterLine = /* @__PURE__ */ memo(function RoadsterLine(_props: IconProps) {
...
/**
 * Remix Icon: Roadster Line
 * @see {@link https://remixicon.com/icon/roadster-line Remix Icon Docs}
 */
export { RoadsterLine }
