...
Icon.displayName = 'CreativeCommonsZeroLine'
/**
 * Remix Icon: Creative Commons Zero Line
 * @see {@link https://remixicon.com/icon/creative-commons-zero-line Remix Icon Docs}
 */
export const CreativeCommonsZeroLine = Icon
