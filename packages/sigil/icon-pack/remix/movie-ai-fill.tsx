...
const MovieAiFill = /* @__PURE__ */ memo(function MovieAiFill(_props: IconProps) {
...
/**
 * Remix Icon: Movie Ai Fill
 * @see {@link https://remixicon.com/icon/movie-ai-fill Remix Icon Docs}
 */
export { MovieAiFill }
