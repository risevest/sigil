...
const TaobaoFill = /* @__PURE__ */ memo(function TaobaoFill(_props: IconProps) {
...
/**
 * Remix Icon: Taobao Fill
 * @see {@link https://remixicon.com/icon/taobao-fill Remix Icon Docs}
 */
export { TaobaoFill }
