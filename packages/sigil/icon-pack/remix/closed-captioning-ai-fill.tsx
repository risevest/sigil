...
Icon.displayName = 'ClosedCaptioningAiFill'
/**
 * Remix Icon: Closed Captioning Ai Fill
 * @see {@link https://remixicon.com/icon/closed-captioning-ai-fill Remix Icon Docs}
 */
export const ClosedCaptioningAiFill = Icon
