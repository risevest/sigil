...
const BlenderLine = /* @__PURE__ */ memo(function BlenderLine(_props: IconProps) {
...
/**
 * Remix Icon: Blender Line
 * @see {@link https://remixicon.com/icon/blender-line Remix Icon Docs}
 */
export { BlenderLine }
