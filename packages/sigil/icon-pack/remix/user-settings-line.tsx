...
Icon.displayName = 'UserSettingsLine'
/**
 * Remix Icon: User Settings Line
 * @see {@link https://remixicon.com/icon/user-settings-line Remix Icon Docs}
 */
export const UserSettingsLine = Icon
