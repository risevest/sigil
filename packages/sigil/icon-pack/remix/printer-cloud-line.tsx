...
Icon.displayName = 'PrinterCloudLine'
/**
 * Remix Icon: Printer Cloud Line
 * @see {@link https://remixicon.com/icon/printer-cloud-line Remix Icon Docs}
 */
export const PrinterCloudLine = Icon
