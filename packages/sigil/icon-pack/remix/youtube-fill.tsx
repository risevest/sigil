...
const YoutubeFill = /* @__PURE__ */ memo(function YoutubeFill(_props: IconProps) {
...
/**
 * Remix Icon: Youtube Fill
 * @see {@link https://remixicon.com/icon/youtube-fill Remix Icon Docs}
 */
export { YoutubeFill }
