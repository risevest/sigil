...
Icon.displayName = 'WirelessChargingLine'
/**
 * Remix Icon: Wireless Charging Line
 * @see {@link https://remixicon.com/icon/wireless-charging-line Remix Icon Docs}
 */
export const WirelessChargingLine = Icon
