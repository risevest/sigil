...
Icon.displayName = 'CameraLensAiFill'
/**
 * Remix Icon: Camera Lens Ai Fill
 * @see {@link https://remixicon.com/icon/camera-lens-ai-fill Remix Icon Docs}
 */
export const CameraLensAiFill = Icon
