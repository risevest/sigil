...
Icon.displayName = 'Settings3Fill'
/**
 * Remix Icon: Settings 3 Fill
 * @see {@link https://remixicon.com/icon/settings-3-fill Remix Icon Docs}
 */
export const Settings3Fill = Icon
