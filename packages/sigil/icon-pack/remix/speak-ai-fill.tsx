...
const SpeakAiFill = /* @__PURE__ */ memo(function SpeakAiFill(_props: IconProps) {
...
/**
 * Remix Icon: Speak Ai Fill
 * @see {@link https://remixicon.com/icon/speak-ai-fill Remix Icon Docs}
 */
export { SpeakAiFill }
