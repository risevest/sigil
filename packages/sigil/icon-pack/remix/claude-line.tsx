...
const ClaudeLine = /* @__PURE__ */ memo(function ClaudeLine(_props: IconProps) {
...
/**
 * Remix Icon: Claude Line
 * @see {@link https://remixicon.com/icon/claude-line Remix Icon Docs}
 */
export { ClaudeLine }
