...
const Store2Line = /* @__PURE__ */ memo(function Store2Line(_props: IconProps) {
...
/**
 * Remix Icon: Store 2 Line
 * @see {@link https://remixicon.com/icon/store-2-line Remix Icon Docs}
 */
export { Store2Line }
