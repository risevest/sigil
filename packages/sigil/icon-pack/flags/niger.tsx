...
const Niger = /* @__PURE__ */ memo(function Niger(_props: IconProps) {
  ...
  return (
    <Svg fill="none" viewBox="0 0 40 40" width={size} height={size} {...props}>
      <G clipPath="url(#a)">
        ...
        <Path
          fill="#FF9811"
          d="M1.985 11.304h36.03C34.78 4.614 27.929 0 20 0S5.22 4.614 1.985 11.304M20 26.957a6.956 6.956 0 1 0 0-13.913 6.956 6.956 0 0 0 0 13.912"
        />
      </G>
      <Defs>
        <ClipPath id="a">
